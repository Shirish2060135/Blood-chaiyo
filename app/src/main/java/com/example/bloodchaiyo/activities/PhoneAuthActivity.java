...
import com.example.bloodchaiyo.Main.LoginSignUp;
...
public class PhoneAuthActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btnSignIn,btnVerify,btnResend, btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister = findViewById(R.id.btn_redirect);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent = new Intent(PhoneAuthActivity.this, LoginSignUp.class);
